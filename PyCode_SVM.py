...
clf2 = SVC(probability=True,class_weight='balanced',kernel='linear')
...
y_pred_fold_te=calibrated_classifier.predict(X_test)
test_report_dict = metrics.classification_report(
	y_test,
	y_pred_fold_te,
	labels = [0, 1],
	target_names=['malign', 'benign'],
